const translations = {
    tr: {
        ...
        skill_creative: "Yaratıcı Sorun Çözme",
        skill_entrepreneur: "Girişimcilik",
        ...
        edu_date: "Eylül 2021 - Haziran 2026",
        certs_title: "Sertifikalar",
        cert_ethical: "Ethical Hacker (Cisco)",
        cert_mckinsey: "McKinsey.org Forward Program",
        cert_intro_cyber: "Introduction to Cybersecurity (Cisco)",
        cert_net_basics: "Networking Basics (Cisco)",
        cert_py_ess2: "Python Essentials 2 (Cisco)",
        cert_dia: "DİA ERP ve İş Süreçleri Eğitimi (Çankaya Üni, 2025)",
        cert_btk_py: "Sıfırdan İleri Seviye Python Programlama (BTK Akademi, 2025)",
        cert_iso: "ISO 9001:2015 Temel Kalite Yönetim Sistemleri (Acadezone, 2025)",
        cert_ml_summer: "Yapay Öğrenme Yaz Okulu (Bilim Akademisi/ODTÜ, 2024)",
        cert_btk_cyber: "Siber Güvenliğe Giriş (BTK Akademi, 2023)",
        cert_ai_everyone: "AI For Everyone (Coursera)",
        cert_borusan: "Borusan Teknoloji Okulu (Toptalent, 2023)",
        cert_ccna: "Cisco CCNAv7: Bridging Certificate (2022)",
        cert_acadezone_sem: "Havacılık ve Savunma Sanayinde Uluslararası Düzenlemeler Semineri (Acadezone, 2025)",
    ...
    en: {
        ...
        skill_creative: "Creative Problem Solving",
        skill_entrepreneur: "Entrepreneurship",
        ...
        edu_date: "September 2021 - June 2026",
        ...
        cert_net_basics: "Networking Basics (Cisco)",
        cert_py_ess2: "Python Essentials 2 (Cisco)",
        cert_dia: "DİA ERP and Business Process Training (Çankaya Uni, 2025)",
        cert_btk_py: "Zero to Advanced Python Programming (BTK Akademi, 2025)",
        cert_iso: "ISO 9001:2015 Fundamental Quality Management Systems (Acadezone, 2025)",
        cert_ml_summer: "Machine Learning Summer School (Science Academy/METU, 2024)",
        cert_btk_cyber: "Introduction to Cybersecurity (BTK Akademi, 2023)",
        cert_ai_everyone: "AI For Everyone (Coursera)",
        cert_borusan: "Borusan Technology School (Toptalent, 2023)",
        cert_ccna: "Cisco CCNAv7: Bridging Certificate (2022)",
        cert_acadezone_sem: "Seminar on Recent Advances in Aerospace & Defense (Acadezone, 2025)",
    ...
    if (hamburger) {
        hamburger.addEventListener('click', () => {
            if (navLinks.style.display === 'flex') {
                ...
                // Inline styles for basic toggle, can be improved with classes
